" Naitik Shah <naitik.shah@yahoo.com>
...
let colors_name = "daaku"

" Default Colors
hi Normal       guifg=#d3d7cf guibg=#000000 gui=none
hi NonText      guifg=#3465a4 guibg=#000000 gui=none
hi NonText      ctermfg=darkblue cterm=none
hi Cursor       guibg=#d3d7cf
hi lCursor      guibg=#d3d7cf

" Search
hi Search       guifg=#000000 guibg=#3465a4
hi Search       cterm=none ctermfg=black ctermbg=darkblue
hi IncSearch    guibg=#d3d7cf guifg=#3465a4
hi IncSearch    cterm=none ctermfg=white ctermbg=darkblue

" Window Elements
hi StatusLine   guifg=#000000 guibg=#d3d7df gui=bold
hi StatusLine   ctermfg=cyan ctermbg=black cterm=bold
hi StatusLineNC guifg=#d3d7df guibg=#4e9a06
hi StatusLineNC ctermfg=darkgray ctermbg=black
hi VertSplit    guifg=#d3d7cf guibg=#d3d7cf
hi Folded       guifg=#d3d7cf guibg=#75507b
hi Folded       ctermfg=white ctermbg=magenta
hi Visual       guifg=#000000 guibg=#4e9a06
hi Visual       ctermbg=none ctermfg=lightgreen cterm=reverse

" Specials
hi Todo         guifg=#8ae234 guibg=#4e9a06 gui=bold
hi Todo         ctermfg=white ctermbg=green
hi Title        guifg=#d3d7cf gui=bold
hi Title        ctermfg=white cterm=bold

" Syntax
hi Constant     guifg=#cc0000 gui=bold
hi Constant     ctermfg=red cterm=bold
hi Number       guifg=#cc0000 gui=none
hi Number       ctermfg=red cterm=none
hi Statement    guifg=#c4a000 gui=bold
hi Statement    ctermfg=yellow cterm=bold
hi Identifier   guifg=#06989a gui=none
hi Identifier   ctermfg=red cterm=none
hi Function     guifg=#75507b gui=none
hi Function     ctermfg=magenta cterm=none
hi PreProc      guifg=#884388 gui=none
...
hi Special      guifg=#75507b cterm=none
hi Special      ctermfg=magenta cterm=none
hi Error        guifg=#d3d7cf guibg=#cc0000
hi Error        ctermfg=white ctermbg=red
hi String       guifg=#3465A4 gui=italic
hi String       ctermfg=blue cterm=none
hi Operator     guifg=#06989a gui=none
hi Operator     ctermfg=cyan cterm=none
...
" Pmenu
hi Pmenu        guifg=#ffffff guibg=#75507b
...
hi pythonFunction   ctermfg=red                 gui=bold
